...
// 16x16 sprite patterns (128 bytes each, 4-bit per pixel, 2 pixels per byte)
// Player ship - facing upward for vertical scroller
static const uint8_t sprite_player[128] = {
...
static const uint8_t sprite_bullet[128] = {
...
static const uint8_t sprite_enemy1[128] = {
...
static const uint8_t sprite_enemy2[128] = {
...
static const uint8_t sprite_explosion[128] = {
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
static const uint8_t sprite_highway[128] = {
...
static const uint8_t sprite_life[128] = {
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
static const uint8_t sprite_digits[10][128] = {
    // Digit 0 - 12x12 centered (2px padding each side)
    {
        0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,  // Row 0 - padding
        0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,  // Row 1 - padding
        0x00,0x00,0xFF,0xFF,0xFF,0xF0,0x00,0x00,  // Row 2
        0x00,0x0F,0xF0,0x00,0x0F,0xFF,0x00,0x00,  // Row 3
        0x00,0x0F,0xF0,0x00,0x00,0xFF,0x00,0x00,  // Row 4
        0x00,0x0F,0xF0,0x00,0x00,0xFF,0x00,0x00,  // Row 5
        0x00,0x0F,0xF0,0x00,0x00,0xFF,0x00,0x00,  // Row 6
        0x00,0x0F,0xF0,0x00,0x00,0xFF,0x00,0x00,  // Row 7
        0x00,0x0F,0xF0,0x00,0x00,0xFF,0x00,0x00,  // Row 8
        0x00,0x0F,0xF0,0x00,0x00,0xFF,0x00,0x00,  // Row 9
        0x00,0x0F,0xF0,0x00,0x0F,0xFF,0x00,0x00,  // Row 10
        0x00,0x00,0xFF,0xFF,0xFF,0xF0,0x00,0x00,  // Row 11
        0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,  // Row 12
        0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,  // Row 13 - padding
        0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,  // Row 14 - padding
        0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00   // Row 15 - padding
    },
    // Digit 1
    {
        0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
// 4-bit mode: 16x16 = 128 bytes per pattern
...
// Set sprite attributes (4-bit mode)
void sprite_set(uint8_t slot, int16_t x, int16_t y, uint8_t pattern, uint8_t flags) {
    ...
    // Write attribute bytes (4 bytes for 4-bit sprites)
    ...
    z80_outp(SPRITE_ATTR_PORT, 0x80 | pattern);     // Byte 3: Visible + pattern (no 5th byte)
}

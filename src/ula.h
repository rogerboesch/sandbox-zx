...
#define ATTR_WHITE_ON_GREEN   (ULA_ATTR(ULA_GREEN, ULA_WHITE) | ULA_BRIGHT)
...
#define MENU_WHITE_ON_RED     (ULA_ATTR(ULA_RED, ULA_WHITE) | ULA_BRIGHT)
#define MENU_WHITE_ON_GREEN   (ULA_ATTR(ULA_GREEN, ULA_WHITE) | ULA_BRIGHT)
